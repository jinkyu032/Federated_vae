...
class Config:
    ...
    num_subsets: int = 1 # REQUIRED for 2-stage split
    ...
    @classmethod
    def federated_rounds1000_epochs5_finetune_latentdim22(cls):
        return cls(name="federated_rounds1000_epochs5_finetune_latentdim22", num_rounds=1000, local_epochs=5, finetune_last_model=True, latent_dim=22)

    @classmethod
    def federated_rounds1_epochs100_finetune_latentdim22(cls):
        return cls(name="federated_rounds1_epochs100_finetune_latentdim22", num_rounds=1, local_epochs=100, finetune_last_model=True, latent_dim=22, participation_rate=1)

    @classmethod
    def federated_rounds1000_epochs5_finetuneglobal_latentdim22(cls):
        return cls(name="federated_rounds1000_epochs5_finetuneglobal_latentdim22", num_rounds=1000, local_epochs=5, finetune_last_model=True, finetune_gen_global_model=True, latent_dim=22)



    @classmethod
    def federated_rounds1000_epochs5_finetune_latentdim22_wclientclassifierw1(cls):
        return cls(name="federated_rounds1000_epochs5_finetune_latentdim22_wclientclassifierw1", num_rounds=1000, local_epochs=5, finetune_last_model=True, latent_dim=22, client_classifier=True, model_name="vaewithclientclassifier", use_classifier=True, embedding_loss_weight=1, client_type="withclientclassifier", analyze_latent_space=False, save_dir="./saved_models")


    @classmethod
    def federated_rounds1000_epochs5_finetune_latentdim22_wclientclassifierw01(cls):
        return cls(name="federated_rounds1000_epochs5_finetune_latentdim22_wclientclassifierw01", num_rounds=1000, local_epochs=5, finetune_last_model=True, latent_dim=22, client_classifier=True, model_name="vaewithclientclassifier", use_classifier=True, embedding_loss_weight=0.1, client_type="withclientclassifier", analyze_latent_space=False, save_dir="./saved_models")

    @classmethod
    def federated_rounds1_epochs1_finetune_latentdim22_wclientclassifierw01(cls):
        return cls(name="federated_rounds1_epochs1_finetune_latentdim22_wclientclassifierw01", num_rounds=1, local_epochs=1, finetune_last_model=True, latent_dim=22, client_classifier=True, model_name="vaewithclientclassifier", use_classifier=True, embedding_loss_weight=0.1, client_type="withclientclassifier", analyze_latent_space=False, save_dir="./saved_models")

    @classmethod
    def federated_rounds1000_epochs5_finetuneglobal_latentdim22_wclientclassifierw01(cls):
        return cls(name="federated_rounds1000_epochs5_finetuneglobal_latentdim22_wclientclassifierw01", num_rounds=1000, local_epochs=5, finetune_last_model=True, latent_dim=22, client_classifier=True, model_name="vaewithclientclassifier", use_classifier=True, embedding_loss_weight=0.1, client_type="withclientclassifier", analyze_latent_space=False, save_dir="./saved_models", finetune_gen_global_model=True)




    @classmethod
    def federated_rounds1000_epochs5_finetune_latentdim22_iid(cls):
        return cls(name="federated_rounds1000_epochs5_finetune_latentdim22_iid", num_rounds=1000, local_epochs=5, finetune_last_model=True, latent_dim=22, split_mode="iid")

    @classmethod
    def federated_rounds1_epochs100_finetune_latentdim22_iid(cls):
        return cls(name="federated_rounds1_epochs100_finetune_latentdim22_iid", num_rounds=1, local_epochs=100, finetune_last_model=True, latent_dim=22, split_mode="iid", participation_rate=1)


    @classmethod
    def federated_rounds1000_epochs5_finetuneglobal_latentdim22_iid(cls):
        return cls(name="federated_rounds1000_epochs5_finetuneglobal_latentdim22_iid", num_rounds=1000, local_epochs=5, finetune_last_model=True, finetune_gen_global_model=True, latent_dim=22, split_mode="iid")

    @classmethod
    def federated_rounds1000_epochs5_finetuneglobal_latentdim22_iid_wclientclassifierw01(cls):
        return cls(name="federated_rounds1000_epochs5_finetuneglobal_latentdim22_iid_wclientclassifierw01", num_rounds=1000, local_epochs=5, finetune_last_model=True, finetune_gen_global_model=True, latent_dim=22, split_mode="iid", client_classifier=True, model_name="vaewithclientclassifier", use_classifier=True, embedding_loss_weight=0.1, client_type="withclientclassifier", analyze_latent_space=False, save_dir="./saved_models")



    @classmethod
    def federated_rounds1000_epochs5_finetune_latentdim22_dir03(cls):
        return cls(name="federated_rounds1000_epochs5_finetune_latentdim22_dir03", num_rounds=1000, local_epochs=5, finetune_last_model=True, latent_dim=22, split_mode="dirichlet")

    @classmethod
    def federated_rounds1_epochs100_finetune_latentdim22_dir03(cls):
        return cls(name="federated_rounds1_epochs100_finetune_latentdim22_dir03", num_rounds=1, local_epochs=100, finetune_last_model=True, latent_dim=22, split_mode="dirichlet", participation_rate=1)

    @classmethod
    def federated_rounds1000_epochs5_finetuneglobal_latentdim22_dir03(cls):
        return cls(name="federated_rounds1000_epochs5_finetuneglobal_latentdim22_dir03", num_rounds=1000, local_epochs=5, finetune_last_model=True, finetune_gen_global_model=True, latent_dim=22, split_mode="dirichlet")

    @classmethod
    def federated_rounds1000_epochs5_finetuneglobal_latentdim22_dir03_wclientclassifierw01(cls):
        return cls(name="federated_rounds1000_epochs5_finetuneglobal_latentdim22_dir03_wclientclassifierw01", num_rounds=1000, local_epochs=5, finetune_last_model=True, finetune_gen_global_model=True, latent_dim=22, split_mode="dirichlet", client_classifier=True, model_name="vaewithclientclassifier", use_classifier=True, embedding_loss_weight=0.1, client_type="withclientclassifier", analyze_latent_space=False, save_dir="./saved_models")
 


    @classmethod
    def federated_rounds1_epochs100_finetune_latentdim22_iid_2client(cls):
        return cls(name="federated_rounds1_epochs100_finetune_latentdim22_iid_2client", num_rounds=1, local_epochs=100, finetune_last_model=True, latent_dim=22, split_mode="iid", num_clients=2, participation_rate=1)



    @classmethod
    def federated_rounds1000_epochs5_finetune_latentdim22_dir005(cls):
        return cls(name="federated_rounds1000_epochs5_finetune_latentdim22_dir005", num_rounds=1000, local_epochs=5, finetune_last_model=True, latent_dim=22, split_mode="dirichlet", dirichlet_alpha=0.05)

    @classmethod
    def federated_rounds1_epochs100_finetune_latentdim22_dir005(cls):
        return cls(name="federated_rounds1_epochs100_finetune_latentdim22_dir005", num_rounds=1, local_epochs=100, finetune_last_model=True, latent_dim=22, split_mode="dirichlet", participation_rate=1, dirichlet_alpha=0.05)

    @classmethod
    def federated_rounds1000_epochs5_finetuneglobal_latentdim22_dir005(cls):
        return cls(name="federated_rounds1000_epochs5_finetuneglobal_latentdim22_dir005", num_rounds=1000, local_epochs=5, finetune_last_model=True, finetune_gen_global_model=True, latent_dim=22, split_mode="dirichlet", dirichlet_alpha=0.05)


    @classmethod
    def federated_rounds1000_epochs5_finetuneglobal_latentdim22_dir005_wclientclassifierw01(cls):
        return cls(name="federated_rounds1000_epochs5_finetuneglobal_latentdim22_dir005_wclientclassifierw01", num_rounds=1000, local_epochs=5, finetune_last_model=True, finetune_gen_global_model=True, latent_dim=22, split_mode="dirichlet", client_classifier=True, model_name="vaewithclientclassifier", use_classifier=True, embedding_loss_weight=0.1, client_type="withclientclassifier", analyze_latent_space=False, save_dir="./saved_models", dirichlet_alpha=0.05)
 


    @classmethod
    def federated_rounds1000_epochs5_finetuneglobal_latentdim22_dir100(cls):
        return cls(name="federated_rounds1000_epochs5_finetuneglobal_latentdim22_dir100", num_rounds=1000, local_epochs=5, finetune_last_model=True, finetune_gen_global_model=True, latent_dim=22, split_mode="dirichlet", dirichlet_alpha=100)
