...
from .vaewithclientclassifier import VAEWithClientClassifier
...
def get_model(cfg: Dict):
    ...
    elif cfg.model_name == "convvae":
        return CONVVAE(latent_dim=latent_dim, num_classes=num_classes, batch_norm=batch_norm, cfg = cfg)
    elif cfg.model_name == "vaewithclientclassifier":
        return VAEWithClientClassifier(latent_dim=latent_dim, num_classes=num_classes, batch_norm=batch_norm, cfg = cfg)
    else:
